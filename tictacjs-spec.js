...
/*    STEP 2: Uncomment this out.*/
    ...
    it("should update the visual board correctly based on the board variable", function() {
        board = ["X", "O", "X", null, null, null, null, null, null];
        updateBoard();
        var cellNumber1 = $("#cell-1").text();
        var cellNumber2 = $("#cell-2").text();
        expect(cellNumber1).toEqual("O");
        expect(cellNumber2).toEqual("X");
